          ...
          <div className="home">
            <GridContainer style={{ 'grid-template-columns': '1fr 1fr' }}>
              ...
              <CardDiv>
                ...
                <CardBody>
                  <CardTitle>Fitshere Social</CardTitle>
                  <CardText>
                    You're not alone. Find people to follow. Share your
                    progress. The Fitshere community is a here to support you.
                  </CardText>
              ...
              <CardDiv>
                ...
                <CardBody>
                  <CardTitle>Fitshere Profile</CardTitle>
                  <CardText>
      ...
      return (
        <div>
          <Hero backgroundImage={spartan}>
            <Menu />
            <h3>
              Fit<span class="text-info">Sphere</span>
            </h3>
            <h1>
              This is Fit<span className="text-info">Sphere</span>
            </h1>
            <h2>A fitness community</h2>
            <p>
              Fitshere is a fitness application which uses data-based progress
